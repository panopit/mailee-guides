...
Em vez de criarmos uma importação apenas de arquivos MS Excel, nós fizemos uma importação intermediária, na qual você precisa fazer um "copy" e "paste" da sua planilha, assim você pode importar, além do MS Excel, planilhas do Open Office, Google Docs ou Numbers do iWork. Vamos ver:
