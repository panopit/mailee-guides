...
<dl> 
	<% guide('Como funcionam as campanhas', 'what_is_a_campaign.html') do %>
		O que é uma campanha e para que serve.
	<% end %>
...
<dl>
  ...
  <% guide('Usuários', 'users.html') do %>
    Como criar mais usuários e os níveis de permissões disponíveis.
  <% end %>
  <% guide('Configuração de links', 'config_links.html') do %>
    Configure os links das mensagens apontarem para o seu site.
  <% end %>
