...
Esta Gem utiliza a API "REST":http://en.wikipedia.org/wiki/Representational_State_Transfer do Mailee. Além dela, existem integrações já prontas para "Spree":integration_spree.html e "PHP":integration_php.html. 
...
Copie a chave, e adicione a seguinte configuração ao seu _config/application.rb_:
