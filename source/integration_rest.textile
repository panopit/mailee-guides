...
<shell>
  curl -X POST -d "list[name]=" http://api.bdb28c0a0a4a3.softa.maileebeta.me/lists.xml
</shell>
...
<shell>
  curl -X PUT -d "list[name]=" http://api.bdb28c0a0a4a3.softa.maileebeta.me/lists/ID.xml
</shell>
