...
!images/integration/spree/cadastro.png(Cadastro no Mailee)!
...
!images/integration/spree/mailee_contact_found_index.png(Contato na lista do Mailee)!

!images/integration/spree/mailee_contact_found_index.png(Visualização do contato no Mailee)!
