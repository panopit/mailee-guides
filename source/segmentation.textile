...
* Neste mês
** Este filtro apresentará os contatos cujos aniversários sejam no mês em que filtro está sendo _aplicado_. Isto significa dizer que, estando em janeiro, você verá os contatos que nasceram em janeiro, da mesma forma, em junho você verá os contatos que nasceram em junho.
* Nesta semana
...
INFO. O Mailee é capaz de buscar automaticamente tags de seus contatos em algumas redes sociais, como o Last.fm (de música) e o Delicious (de _bookmarks_). Tente manter os dados de redes sociais de seus contatos atualizados, pois isto é uma ferramenta muito poderosa de segmentação.
...
O "Klout":http://klout.com é um serviço online que calcula a influência de usuários no "Twitter":http://twitter.com. Sempre que você colocar o usuário do Twitter em algum contato no Mailee, o sistema irá buscar o número Klout do contato.
...
O "LinkedIn":http://linkedin.com é uma rede social com foco em negócios. Sempre que você colocar o usuário do LinkedIn em algum contato no Mailee, o sistema irá buscar o número de conexões no LinkedIn do contato.
...
O "LinkedIn":http://linkedin.com é uma rede social com foco em negócios. Sempre que você colocar o usuário do LinkedIn em algum contato no Mailee, o sistema irá buscar o número de recomendações no LinkedIn do contato.
...
Em todo "campo personalizado":http://todo que você criar no Mailee, será possível aplicar filtros para segmentação.
...
INFO. Uma mensagem é sempre enviada para uma lista. Isto é necessário por uma série de motivos. O primeiro é a prevenir _spam_. Depois, o Mailee permite (e recomenda) que você coloque tags nas mensagens com informações sobre a sua empresa, como site, telefone e até mesmo endereço.
