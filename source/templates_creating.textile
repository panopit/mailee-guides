...
O *link de descadastramento* ou *unsubscribe* é um item recomendado a todas mensagens de email marketing. Ele serve para que o usuário que quiser deixar de receber suas notícias por email, seja por desinteresse, ou qualquer outro motivo, possa ser efetivamente descadastrado de sua lista.

O *Mailee.me* oferece uma solução simples, e para inserir esse link em seus templates basta apenas colocar o seguinte código em seus templates:
