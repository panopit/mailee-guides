...
O Mailee.me oferece uma solução simples, e para inserir esse link em seus templates basta colocar o seguinte código em seus templates:
...
WARNING. Para os *campos personalizados* você deve usar a <samp>tag</samp> deste campo e não o *nome* dos mesmos.


h4. Informações da lista

Todas as mensagens enviadas pelo Mailee.me estão relacionadas a uma lista de contatos. Para colocar os *dados da lista* basta colocar o atributo <samp>class="list"</samp> seguida do campo que você desejar.
...
Para inserir a informação de *endereço* relacionada a lista, basta adicionar um <samp>&lt;span&gt;</samp> com o atributo <samp>class="list address"</samp>, ficando assim:
