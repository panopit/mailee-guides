...
Para realizar *upload* para o sistema, seu arquivo deve conter, obrigatoriamente, conter apenas:
...
A *pré-visualização* ou *preview* tem como objetivo fornecer uma amostra de como o template irá se comportar com a adição de conteúdo pelo usuário. O preenchimento é automático e irá adicionar imagens e textos nos _placeholders_ indicados em seu código HTML.

!images/templates/template_preview.gif(Pré-visualização de template)!

h4. _Checklist_ de templates

A *conferência de conteúdo* ou *checklist* pode ser realizada após a criação ou atualização de seu template e serve para conferir se os elementos que você codificou foram interpretados corretamente no *Mailee.me*.
...
WARNING. *IMPORTANTE:* <br/> O checklist não irá realizar a validação de seu código HTML. Recomendamos a utilização de uma ferramenta externa de "validador de HTML da W3":http://validator.w3.org/check.